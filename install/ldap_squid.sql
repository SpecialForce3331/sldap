...
GRANT USAGE ON *.* TO 'ldap_squid'@'%' IDENTIFIED BY PASSWORD '*AA1420F182E88B9E5F874F6FBE7459291E8F4601';
GRANT ALL PRIVILEGES ON `ldap\_squid`.* TO 'ldap_squid'@'%' WITH GRANT OPTION;
